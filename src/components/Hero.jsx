...
import { links, Nav_links } from "../consts";
...
const Hero = () => {
  ...
  bg-[length:200%_auto] bg-clip-text text-transparent animate-shine mb-4">Hi, I'm Sabith Fariq</div>
                ...
                <div className="flex flex-row gap-2 pt-5 md:pt-5">
                    <a href={links.github} className="text-[#f3f3f398] shadow-xl hover:text-white
                   transition duration-300 ease-in-out border border-1
                    ...
                    <a href={links.linkedin} className="text-[#f3f3f398] shadow-xl hover:text-[#4A86C5]
                   transition duration-300 ease-in-out border border-1
                    border-[#f3f3f310] p-3 rounded-xl bg-[#1414149c] hover:bg-[#f3f3f310]">
                    ...
                    <a href={links.gmail} className="text-[#f3f3f398] shadow-xl hover:text-red-400
                   transition duration-300 ease-in-out border border-1
                    border-[#f3f3f310] p-3 rounded-xl bg-[#1414149c] hover:bg-[#f3f3f310]">
